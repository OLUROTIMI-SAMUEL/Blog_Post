...
using Blogging_Platform.Repositories.Implementation;
...
builder.Services.ConfigureApplicationCookie(op => op.LoginPath = "/UserAuthentication/Login"); // So here the login Path is defined
